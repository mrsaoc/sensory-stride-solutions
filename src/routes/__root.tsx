...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dra. Sylvia | Guia Sensorial da Fascite Plantar" },
      { name: "description", content: "Método de Reintrodução Sensorial da Pisada® — reduza a dor da primeira pisada em até 14 dias com a Dra. Sylvia." },
      { property: "og:title", content: "Dra. Sylvia | Guia Sensorial da Fascite Plantar" },
      { property: "og:description", content: "Método prático de 14 dias para interromper o ciclo da fascite plantar." },
